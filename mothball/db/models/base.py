...
class EBS(Base):
    ...
    tagSet = Column(String(12), default='NULL')
...
class EIP(Base):
    ...
    def __repr__(self):
        return "<EIP(AccountID='{0}', instanceId='{1}', MACaddress_orig='{2}', MACaddress_new='{3}'," \
               ...
               "SubnetId_new='{16}', VpcId_orig='{17}', VpcId_new='{18}', id='{19}'".format(self.AccountId,
                                                                                            self.instanceId,
...
class SecurityGroup(Base):
    ...
    ingressRules = Column(String(255), default='NULL')
    egressRules = Column(String(255), default='NULL')

    def __repr__(self):
        return "<SecurityGroup(AccountID='{0}', sgId='{1}', sgName='{2}', vpcAssn='{3}', ingressRules='{4}'" \
               "egressRules='{5}' id='{6}".format(self.AccountId,
                                                  self.sgId,
                                                  self.sgName,
                                                  self.vpcAssn,
                                                  self.ingressRules,
